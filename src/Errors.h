...
static const char* binance_error_to_string(binance_error e){
    switch ( e ) {
...
static const char* upbit_error_to_string(const upbit_error e){
    switch (e) {
...
static const char* bithumb_error_to_string(bithumb_error e){
    switch ( e ) {
...
static const char* coinbase_error_to_string(coinbase_error e){
    switch ( e ) {
